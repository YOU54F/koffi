...
download_ffi "osx-x86_64.dylib.gz" "lib" "darwin-x64/libpact_ffi.dylib.gz"
download_ffi "osx-aarch64-apple-darwin.dylib.gz" "lib" "darwin-arm64/libpact_ffi.dylib.gz"
