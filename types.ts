...
export namespace PactFfi {
  ...
  export enum StringResult_TagValue {
    ...
    export declare function init(log_env_var: number): void;
  
    /** /data/input/pact.h#L529 */
    export declare function initWithLogLevel(level: number): void;
  
    /** /data/input/pact.h#L538 */
    export declare function enableAnsiSupport(): void;
  
    /** /data/input/pact.h#L553 */
    export declare function logMessage(source: number, log_level: number, message: number): void;
    ...
    export declare function mismatchToJson(mismatch: Mismatch): number;
  
    /** /data/input/pact.h#L592 */
    export declare function mismatchType(mismatch: Mismatch): number;
  
    /** /data/input/pact.h#L597 */
    export declare function mismatchSummary(mismatch: Mismatch): number;
  
    /** /data/input/pact.h#L602 */
    export declare function mismatchDescription(mismatch: Mismatch): number;
  
    /** /data/input/pact.h#L607 */
    export declare function mismatchAnsiDescription(mismatch: Mismatch): number;
  
    /** /data/input/pact.h#L646 */
    export declare function getErrorMessage(buffer: number, length: number): number;
  
    /** /data/input/pact.h#L652 */
    export declare function logToStdout(level_filter: PactFfi.LevelFilter): number;
  
    /** /data/input/pact.h#L657 */
    export declare function logToStderr(level_filter: PactFfi.LevelFilter): number;
  
    /** /data/input/pact.h#L666 */
    export declare function logToFile(file_name: number, level_filter: PactFfi.LevelFilter): number;
  
    /** /data/input/pact.h#L671 */
    export declare function logToBuffer(level_filter: PactFfi.LevelFilter): number;
  
    /** /data/input/pact.h#L688 */
    export declare function loggerInit(): void;
  
    /** /data/input/pact.h#L725 */
    export declare function loggerAttachSink(sink_specifier: number, level_filter: PactFfi.LevelFilter): number;
  
    /** /data/input/pact.h#L735 */
    export declare function loggerApply(): number;
  
    /** /data/input/pact.h#L753 */
    export declare function fetchLogBuffer(log_id: number): number;
  
    /** /data/input/pact.h#L763 */
    export declare function parsePactJson(json: number): Pact;
    ...
    export declare function asyncMessageGetContentsStr(message: AsynchronousMessage): number;
  
    /** /data/input/pact.h#L861 */
    export declare function asyncMessageSetContentsStr(message: AsynchronousMessage, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L877 */
    export declare function asyncMessageGetContentsLength(message: AsynchronousMessage): number;
  
    /** /data/input/pact.h#L893 */
    export declare function asyncMessageGetContentsBin(message: AsynchronousMessage): number;
  
    /** /data/input/pact.h#L913 */
    export declare function asyncMessageSetContentsBin(message: AsynchronousMessage, contents: number, len: number, content_type: number): void;
  
    /** /data/input/pact.h#L934 */
    export declare function asyncMessageGetDescription(message: AsynchronousMessage): number;
  
    /** /data/input/pact.h#L951 */
    export declare function asyncMessageSetDescription(message: AsynchronousMessage, description: number): number;
  
    /** /data/input/pact.h#L970 */
    export declare function asyncMessageGetProviderState(message: AsynchronousMessage, index: number): ProviderState;
    ...
    export declare function consumerGetName(consumer: Consumer): number;
    ...
    export declare function messageContentsGetContentsStr(contents: MessageContents): number;
  
    /** /data/input/pact.h#L1075 */
    export declare function messageContentsSetContentsStr(contents: MessageContents, contents_str: number, content_type: number): void;
  
    /** /data/input/pact.h#L1091 */
    export declare function messageContentsGetContentsLength(contents: MessageContents): number;
  
    /** /data/input/pact.h#L1107 */
    export declare function messageContentsGetContentsBin(contents: MessageContents): number;
  
    /** /data/input/pact.h#L1127 */
    export declare function messageContentsSetContentsBin(contents: MessageContents, contents_bin: number, len: number, content_type: number): void;
    ...
    export declare function parseMatcherDefinition(expression: number): MatchingRuleDefinitionResult;
  
    /** /data/input/pact.h#L1312 */
    export declare function matcherDefinitionError(definition: MatchingRuleDefinitionResult): number;
  
    /** /data/input/pact.h#L1323 */
    export declare function matcherDefinitionValue(definition: MatchingRuleDefinitionResult): number;
    ...
    export declare function matchingRuleId(rule_result: MatchingRuleResult): number;
  
    /** /data/input/pact.h#L1453 */
    export declare function matchingRuleValue(rule_result: MatchingRuleResult): number;
    ...
    export declare function matchingRuleReferenceName(rule_result: MatchingRuleResult): number;
  
    /** /data/input/pact.h#L1504 */
    export declare function validateDatetime(value: number, format: number): number;
  
    /** /data/input/pact.h#L1516 */
    export declare function generatorToJson(generator: Generator): number;
  
    /** /data/input/pact.h#L1526 */
    export declare function generatorGenerateString(generator: Generator, context_json: number): number;
  
    /** /data/input/pact.h#L1537 */
    export declare function generatorGenerateInteger(generator: Generator, context_json: number): number;
    ...
    export declare function syncHttpGetRequestContents(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1632 */
    export declare function syncHttpSetRequestContents(interaction: SynchronousHttp, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L1648 */
    export declare function syncHttpGetRequestContentsLength(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1664 */
    export declare function syncHttpGetRequestContentsBin(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1684 */
    export declare function syncHttpSetRequestContentsBin(interaction: SynchronousHttp, contents: number, len: number, content_type: number): void;
    ...
    export declare function syncHttpGetResponseContents(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1739 */
    export declare function syncHttpSetResponseContents(interaction: SynchronousHttp, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L1755 */
    export declare function syncHttpGetResponseContentsLength(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1771 */
    export declare function syncHttpGetResponseContentsBin(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1791 */
    export declare function syncHttpSetResponseContentsBin(interaction: SynchronousHttp, contents: number, len: number, content_type: number): void;
  
    /** /data/input/pact.h#L1813 */
    export declare function syncHttpGetDescription(interaction: SynchronousHttp): number;
  
    /** /data/input/pact.h#L1830 */
    export declare function syncHttpSetDescription(interaction: SynchronousHttp, description: number): number;
  
    /** /data/input/pact.h#L1849 */
    export declare function syncHttpGetProviderState(interaction: SynchronousHttp, index: number): ProviderState;
    ...
    export declare function matchingRuleToJson(rule: MatchingRule): number;
    ...
    export declare function messageNewFromJson(index: number, json_str: number, spec_version: PactFfi.PactSpecification): Message;
  
    /** /data/input/pact.h#L2099 */
    export declare function messageNewFromBody(body: number, content_type: number): Message;
  
    /** /data/input/pact.h#L2104 */
    export declare function messageDelete(message: Message): void;
  
    /** /data/input/pact.h#L2122 */
    export declare function messageGetContents(message: Message): number;
  
    /** /data/input/pact.h#L2137 */
    export declare function messageSetContents(message: Message, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L2153 */
    export declare function messageGetContentsLength(message: Message): number;
  
    /** /data/input/pact.h#L2169 */
    export declare function messageGetContentsBin(message: Message): number;
  
    /** /data/input/pact.h#L2184 */
    export declare function messageSetContentsBin(message: Message, contents: number, len: number, content_type: number): void;
  
    /** /data/input/pact.h#L2206 */
    export declare function messageGetDescription(message: Message): number;
  
    /** /data/input/pact.h#L2223 */
    export declare function messageSetDescription(message: Message, description: number): number;
  
    /** /data/input/pact.h#L2242 */
    export declare function messageGetProviderState(message: Message, index: number): ProviderState;
    ...
    export declare function messageFindMetadata(message: Message, key: number): number;
  
    /** /data/input/pact.h#L2316 */
    export declare function messageInsertMetadata(message: Message, key: number, value: number): number;
    ...
    export declare function messagePactNewFromJson(file_name: number, json_str: number): MessagePact;
    ...
    export declare function messagePactFindMetadata(message_pact: MessagePact, key1: number, key2: number): number;
    ...
    export declare function providerGetName(provider: Provider): number;
    ...
    export declare function providerStateGetName(provider_state: ProviderState): number;
    ...
    export declare function syncMessageGetRequestContentsStr(message: SynchronousMessage): number;
  
    /** /data/input/pact.h#L2694 */
    export declare function syncMessageSetRequestContentsStr(message: SynchronousMessage, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L2710 */
    export declare function syncMessageGetRequestContentsLength(message: SynchronousMessage): number;
  
    /** /data/input/pact.h#L2726 */
    export declare function syncMessageGetRequestContentsBin(message: SynchronousMessage): number;
  
    /** /data/input/pact.h#L2746 */
    export declare function syncMessageSetRequestContentsBin(message: SynchronousMessage, contents: number, len: number, content_type: number): void;
    ...
    export declare function syncMessageGetNumberResponses(message: SynchronousMessage): number;
  
    /** /data/input/pact.h#L2795 */
    export declare function syncMessageGetResponseContentsStr(message: SynchronousMessage, index: number): number;
  
    /** /data/input/pact.h#L2817 */
    export declare function syncMessageSetResponseContentsStr(message: SynchronousMessage, index: number, contents: number, content_type: number): void;
  
    /** /data/input/pact.h#L2834 */
    export declare function syncMessageGetResponseContentsLength(message: SynchronousMessage, index: number): number;
  
    /** /data/input/pact.h#L2851 */
    export declare function syncMessageGetResponseContentsBin(message: SynchronousMessage, index: number): number;
  
    /** /data/input/pact.h#L2875 */
    export declare function syncMessageSetResponseContentsBin(message: SynchronousMessage, index: number, contents: number, len: number, content_type: number): void;
  
    /** /data/input/pact.h#L2893 */
    export declare function syncMessageGetResponseContents(message: SynchronousMessage, index: number): MessageContents;
  
    /** /data/input/pact.h#L2913 */
    export declare function syncMessageGetDescription(message: SynchronousMessage): number;
  
    /** /data/input/pact.h#L2930 */
    export declare function syncMessageSetDescription(message: SynchronousMessage, description: number): number;
  
    /** /data/input/pact.h#L2950 */
    export declare function syncMessageGetProviderState(message: SynchronousMessage, index: number): ProviderState;
    ...
    export declare function stringDelete(string: number): void;
  
    /** /data/input/pact.h#L3003 */
    export declare function createMockServer(pact_str: number, addr_str: number, tls: number): number;
  
    /** /data/input/pact.h#L3017 */
    export declare function getTlsCaCertificate(): number;
  
    /** /data/input/pact.h#L3043 */
    export declare function createMockServerForPact(pact: PactFfi.PactHandle, addr_str: number, tls: number): number;
  
    /** /data/input/pact.h#L3079 */
    export declare function createMockServerForTransport(pact: PactFfi.PactHandle, addr: number, port: number, transport: number, transport_config: number): number;
  
    /** /data/input/pact.h#L3091 */
    export declare function mockServerMatched(mock_server_port: number): number;
  
    /** /data/input/pact.h#L3108 */
    export declare function mockServerMismatches(mock_server_port: number): number;
  
    /** /data/input/pact.h#L3115 */
    export declare function cleanupMockServer(mock_server_port: number): number;
  
    /** /data/input/pact.h#L3138 */
    export declare function writePactFile(mock_server_port: number, directory: number, overwrite: number): number;
  
    /** /data/input/pact.h#L3147 */
    export declare function mockServerLogs(mock_server_port: number): number;
  
    /** /data/input/pact.h#L3159 */
    export declare function generateDatetimeString(format: number): StringResult;
  
    /** /data/input/pact.h#L3169 */
    export declare function checkRegex(regex: number, example: number): number;
  
    /** /data/input/pact.h#L3180 */
    export declare function generateRegexValue(regex: number): StringResult;
  
    /** /data/input/pact.h#L3192 */
    export declare function freeString(s: number): void;
  
    /** /data/input/pact.h#L3203 */
    export declare function newPact(consumer_name: number, provider_name: number): PactFfi.PactHandle;
  
    /** /data/input/pact.h#L3212 */
    export declare function newInteraction(pact: PactFfi.PactHandle, description: number): PactFfi.InteractionHandle;
  
    /** /data/input/pact.h#L3220 */
    export declare function newMessageInteraction(pact: PactFfi.PactHandle, description: number): PactFfi.InteractionHandle;
  
    /** /data/input/pact.h#L3228 */
    export declare function newSyncMessageInteraction(pact: PactFfi.PactHandle, description: number): PactFfi.InteractionHandle;
  
    /** /data/input/pact.h#L3236 */
    export declare function uponReceiving(interaction: PactFfi.InteractionHandle, description: number): number;
  
    /** /data/input/pact.h#L3244 */
    export declare function given(interaction: PactFfi.InteractionHandle, description: number): number;
  
    /** /data/input/pact.h#L3263 */
    export declare function interactionTestName(interaction: PactFfi.InteractionHandle, test_name: number): number;
  
    /** /data/input/pact.h#L3276 */
    export declare function givenWithParam(interaction: PactFfi.InteractionHandle, description: number, name: number, value: number): number;
  
    /** /data/input/pact.h#L3297 */
    export declare function withRequest(interaction: PactFfi.InteractionHandle, method: number, path: number): number;
  
    /** /data/input/pact.h#L3311 */
    export declare function withQueryParameter(interaction: PactFfi.InteractionHandle, name: number, index: number, value: number): number;
  
    /** /data/input/pact.h#L3352 */
    export declare function withQueryParameterV2(interaction: PactFfi.InteractionHandle, name: number, index: number, value: number): number;
  
    /** /data/input/pact.h#L3364 */
    export declare function withSpecification(pact: PactFfi.PactHandle, version: PactFfi.PactSpecification): number;
  
    /** /data/input/pact.h#L3376 */
    export declare function withPactMetadata(pact: PactFfi.PactHandle, namespace_: number, name: number, value: number): number;
  
    /** /data/input/pact.h#L3392 */
    export declare function withHeader(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, name: number, index: number, value: number): number;
  
    /** /data/input/pact.h#L3434 */
    export declare function withHeaderV2(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, name: number, index: number, value: number): number;
  
    /** /data/input/pact.h#L3446 */
    export declare function responseStatus(interaction: PactFfi.InteractionHandle, status: number): number;
  
    /** /data/input/pact.h#L3474 */
    export declare function withBody(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, content_type: number, body: number): number;
  
    /** /data/input/pact.h#L3506 */
    export declare function withBinaryFile(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, content_type: number, body: number, size: number): number;
  
    /** /data/input/pact.h#L3537 */
    export declare function withMultipartFile(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, content_type: number, file: number, part_name: number): StringResult;
    ...
    export declare function newMessagePact(consumer_name: number, provider_name: number): PactFfi.MessagePactHandle;
  
    /** /data/input/pact.h#L3613 */
    export declare function newMessage(pact: PactFfi.MessagePactHandle, description: number): PactFfi.MessageHandle;
  
    /** /data/input/pact.h#L3620 */
    export declare function messageExpectsToReceive(message: PactFfi.MessageHandle, description: number): void;
  
    /** /data/input/pact.h#L3627 */
    export declare function messageGiven(message: PactFfi.MessageHandle, description: number): void;
  
    /** /data/input/pact.h#L3636 */
    export declare function messageGivenWithParam(message: PactFfi.MessageHandle, description: number, name: number, value: number): void;
  
    /** /data/input/pact.h#L3655 */
    export declare function messageWithContents(message_handle: PactFfi.MessageHandle, content_type: number, body: number, size: number): void;
  
    /** /data/input/pact.h#L3666 */
    export declare function messageWithMetadata(message_handle: PactFfi.MessageHandle, key: number, value: number): void;
  
    /** /data/input/pact.h#L3676 */
    export declare function messageReify(message_handle: PactFfi.MessageHandle): number;
  
    /** /data/input/pact.h#L3698 */
    export declare function writeMessagePactFile(pact: PactFfi.MessagePactHandle, directory: number, overwrite: number): number;
  
    /** /data/input/pact.h#L3710 */
    export declare function withMessagePactMetadata(pact: PactFfi.MessagePactHandle, namespace_: number, name: number, value: number): void;
  
    /** /data/input/pact.h#L3740 */
    export declare function pactHandleWriteFile(pact: PactFfi.PactHandle, directory: number, overwrite: number): number;
  
    /** /data/input/pact.h#L3749 */
    export declare function newAsyncMessage(pact: PactFfi.PactHandle, description: number): PactFfi.MessageHandle;
  
    /** /data/input/pact.h#L3761 */
    export declare function freePactHandle(pact: PactFfi.PactHandle): number;
  
    /** /data/input/pact.h#L3773 */
    export declare function freeMessagePactHandle(pact: PactFfi.MessagePactHandle): number;
  
    /** /data/input/pact.h#L3795 */
    export declare function verify(args: number): number;
  
    /** /data/input/pact.h#L3812 */
    export declare function verifierNew(): VerifierHandle;
  
    /** /data/input/pact.h#L3826 */
    export declare function verifierNewForApplication(name: number, version: number): VerifierHandle;
  
    /** /data/input/pact.h#L3831 */
    export declare function verifierShutdown(handle: VerifierHandle): void;
  
    /** /data/input/pact.h#L3843 */
    export declare function verifierSetProviderInfo(handle: VerifierHandle, name: number, scheme: number, host: number, port: number, path: number): void;
  
    /** /data/input/pact.h#L3864 */
    export declare function verifierAddProviderTransport(handle: VerifierHandle, protocol: number, port: number, path: number, scheme: number): void;
  
    /** /data/input/pact.h#L3883 */
    export declare function verifierSetFilterInfo(handle: VerifierHandle, filter_description: number, filter_state: number, filter_no_state: number): void;
  
    /** /data/input/pact.h#L3904 */
    export declare function verifierSetProviderState(handle: VerifierHandle, url: number, teardown: number, body: number): void;
  
    /** /data/input/pact.h#L3920 */
    export declare function verifierSetVerificationOptions(handle: VerifierHandle, disable_ssl_verification: number, request_timeout: bigint): number;
  
    /** /data/input/pact.h#L3935 */
    export declare function verifierSetColouredOutput(handle: VerifierHandle, coloured_output: number): number;
  
    /** /data/input/pact.h#L3949 */
    export declare function verifierSetNoPactsIsError(handle: VerifierHandle, is_error: number): number;
  
    /** /data/input/pact.h#L3969 */
    export declare function verifierSetPublishOptions(handle: VerifierHandle, provider_version: number, build_url: number, provider_tags: number, provider_tags_len: number, provider_branch: number): number;
  
    /** /data/input/pact.h#L3985 */
    export declare function verifierSetConsumerFilters(handle: VerifierHandle, consumer_filters: number, consumer_filters_len: number): void;
  
    /** /data/input/pact.h#L3997 */
    export declare function verifierAddCustomHeader(handle: VerifierHandle, header_name: number, header_value: number): void;
  
    /** /data/input/pact.h#L4010 */
    export declare function verifierAddFileSource(handle: VerifierHandle, file: number): void;
  
    /** /data/input/pact.h#L4022 */
    export declare function verifierAddDirectorySource(handle: VerifierHandle, directory: number): void;
  
    /** /data/input/pact.h#L4036 */
    export declare function verifierUrlSource(handle: VerifierHandle, url: number, username: number, password: number, token: number): void;
  
    /** /data/input/pact.h#L4055 */
    export declare function verifierBrokerSource(handle: VerifierHandle, url: number, username: number, password: number, token: number): void;
  
    /** /data/input/pact.h#L4082 */
    export declare function verifierBrokerSourceWithSelectors(handle: VerifierHandle, url: number, username: number, password: number, token: number, enable_pending: number, include_wip_pacts_since: number, provider_tags: number, provider_tags_len: number, provider_branch: number, consumer_version_selectors: number, consumer_version_selectors_len: number, consumer_version_tags: number, consumer_version_tags_len: number): void;
  
    /** /data/input/pact.h#L4104 */
    export declare function verifierExecute(handle: VerifierHandle): number;
  
    /** /data/input/pact.h#L4155 */
    export declare function verifierCliArgs(): number;
  
    /** /data/input/pact.h#L4164 */
    export declare function verifierLogs(handle: VerifierHandle): number;
  
    /** /data/input/pact.h#L4173 */
    export declare function verifierLogsForProvider(provider_name: number): number;
  
    /** /data/input/pact.h#L4184 */
    export declare function verifierOutput(handle: VerifierHandle, strip_ansi: number): number;
  
    /** /data/input/pact.h#L4192 */
    export declare function verifierJson(handle: VerifierHandle): number;
  
    /** /data/input/pact.h#L4220 */
    export declare function usingPlugin(pact: PactFfi.PactHandle, plugin_name: number, plugin_version: number): number;
  
    /** /data/input/pact.h#L4228 */
    export declare function cleanupPlugins(pact: PactFfi.PactHandle): void;
  
    /** /data/input/pact.h#L4258 */
    export declare function interactionContents(interaction: PactFfi.InteractionHandle, part: PactFfi.InteractionPart, content_type: number, contents: number): number;
  
    /** /data/input/pact.h#L4279 */
    export declare function matchesStringValue(matching_rule: MatchingRule, expected_value: number, actual_value: number, cascaded: number): number;
  
    /** /data/input/pact.h#L4299 */
    export declare function matchesU64Value(matching_rule: MatchingRule, expected_value: number, actual_value: number, cascaded: number): number;
  
    /** /data/input/pact.h#L4319 */
    export declare function matchesI64Value(matching_rule: MatchingRule, expected_value: number, actual_value: number, cascaded: number): number;
  
    /** /data/input/pact.h#L4339 */
    export declare function matchesF64Value(matching_rule: MatchingRule, expected_value: bigint, actual_value: bigint, cascaded: number): number;
  
    /** /data/input/pact.h#L4359 */
    export declare function matchesBoolValue(matching_rule: MatchingRule, expected_value: number, actual_value: number, cascaded: number): number;
  
    /** /data/input/pact.h#L4383 */
    export declare function matchesBinaryValue(matching_rule: MatchingRule, expected_value: number, expected_value_len: number, actual_value: number, actual_value_len: number, cascaded: number): number;
  
    /** /data/input/pact.h#L4406 */
    export declare function matchesJsonValue(matching_rule: MatchingRule, expected_value: number, actual_value: number, cascaded: number): number;
}
